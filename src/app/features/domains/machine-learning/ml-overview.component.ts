...
export class MlOverviewComponent extends DomainOverviewBase {
  protected override readonly domainId    = 'machine-learning' as const;
  protected override readonly domainLabel = 'Machine Learning';
}