...
export class PythonOverviewComponent extends DomainOverviewBase {
  protected override readonly domainId    = 'python' as const;
  protected override readonly domainLabel = 'Python';
}